...
for opinion in opinions:
    single_opinion = {
        ...
        "recommendation": opinion.select_one("span.user-post__author-recommendation").text.strip(),
        ...
        "pros": [pros.text.strip() for pros in opinion.select("div.review-feature__col:has(> div. review-feature__title review-feature__title--positives) > div.review-feature__item")],
        "cons": [cons.text.strip() for cons in opinion.select("div.review-feature__col:has(> div. review-feature__title review-feature__title--negatives) > div.review-feature__item")],
    }
